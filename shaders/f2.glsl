...
void main() {
    ...
    gl_FragColor = linearToOutputTexel( gl_FragColor );
        ...
        // samplerCube envMap = probe[0].cubeTexture;
        vec3 envMapPosition = probe[0].center;
        vec3 envMapSize = probe[0].size;
        mat3 envMapRotation;
        float roughness = material.roughness;
        ...
        // vec4 envMapColor = textureCubeUV( myenv2, vec3(1.0), 1.0 );
        
        vec4 envMapColor = textureCubeUV( probe[0].cubeTexture, envMapRotation * reflectVec, 1.0 );
        // vec3 envMapColor = texture2D( probe[0].envTexture, reflectVec.xy / reflectVec.z ).rgb;
